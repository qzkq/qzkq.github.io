---
title: 深度学习面试笔试之循环神经网络(RNN)、门控循环单元（GRU）、长短期记忆(LSTM)
date: 2026-01-05 08:08:00
tags:
  - "深度学习"
  - "RNN"
  - "LSTM"
...
![在这里插入图片描述](/img/ca0152a94d0546ecbb8509cfbebd87e8.png)

 是序列中时间步t的小批量输入，
![在这里插入图片描述](/img/9ed31d287bbc4c48853af17d6b0eb2c8.png)

 是该时间步的隐藏变量。那么根据以上结构图当前的隐藏变量的公式如下：

![在这里插入图片描述](/img/e988331589324c9890f1690fac24182f.png)
...
![在这里插入图片描述](/img/eeed1788be89465597b81ebb3d596b98.png)
...
![在这里插入图片描述](/img/d8eae174711540748a383fb5af3b7e16.png)

在双向循环神经⽹络的架构中，设该时间步正向隐藏状态为

![在这里插入图片描述](/img/a8b2a669192d4d9287f805486590463d.png)
...
![在这里插入图片描述](/img/9a0f96e93640451181a799b88d3e1718.png)

然后我们连结两个⽅向的隐藏状态 来得到隐藏状态，并将其输⼊到输出层。输出层计算输出，(输出个数为q)：

![在这里插入图片描述](/img/c42b511e10ce43f5afe6ebdc41d95924.png)
...
![在这里插入图片描述](/img/377caeb0392d427ea9d3336b389f284a.png)
...
![在这里插入图片描述](/img/95b84dc9e3e443c49fd1b68cc4d65716.png)
...
![在这里插入图片描述](/img/2608bb0f5c09496fa548504cd1019330.png)

具体来说，假设隐藏单元个数为 h，给定时间步 t 的小批量输⼊ （样本数为n，输⼊个数为d）和上⼀时间步隐藏状态。重置门 和更新门 的计算如下：

![在这里插入图片描述](/img/22a6a779343b4626aff180aea8cf65e3.png)


![在这里插入图片描述](/img/f9be02982bdd445ca22036529e47a48a.png)
...
![在这里插入图片描述](/img/28821186cd944b53846af0ec1fad8145.png)
...
![在这里插入图片描述](/img/f62e8f6f3523481bb5b56a8190008e1f.png)
...
![](/img/a6f3e3b0b50344908bb4d559be8f38eb.png)

具体来说，假设隐藏单元个数为 h，给定时间步 t 的小批量输入  （样本数为n，输⼊个数为d）和上⼀时间步隐藏状态。三个门的公式如下：
**输入门**： 

![添加图片注释，不超过 140 字（可选）](/img/7c0aef3dfbe24062a32841934568b1ac.png)

**遗忘问**：

![添加图片注释，不超过 140 字（可选）](/img/cc438f3ddee5488b92007056fd9535bd.png)

**输出门**： 

![添加图片注释，不超过 140 字（可选）](/img/d71b2441639f422bb64fd6f755b2b546.png)

## 3. 候选记忆细胞
接下来，长短期记忆需要计算候选记忆细胞  。它的计算与上⾯介绍的3个门类似，但使用了值域在[−1, 1]的tanh函数作为激活函数，如下图所示：

![添加图片注释，不超过 140 字（可选）](/img/fb225150612d42be8198733ae297be06.png)

具体来说，时间步t的候选记忆细胞计算如下：

![添加图片注释，不超过 140 字（可选）](/img/3de21d6b5cb74409a86bd7e4259ba59c.png)
...
![添加图片注释，不超过 140 字（可选）](/img/213ed13d1fd64ec8b92ec502214c5a08.png)
...
![添加图片注释，不超过 140 字（可选）](/img/418e37a6eefb4e19a97e40943f8f36b8.png)

## 5. 隐藏状态
有了记忆细胞以后，接下来我们还可以通过输出门来控制从记忆细胞到隐藏状态  的信息的流动：

![添加图片注释，不超过 140 字（可选）](/img/21ce46895d17421aade95810cecb0396.png)

这⾥的tanh函数确保隐藏状态元素值在-1到1之间。需要注意的是，当输出门近似1时，记忆细胞信息将传递到隐藏状态供输出层使用；当输出门近似0时，记忆细胞信息只自己保留。**下图展示了长短期记忆中隐藏状态的全部计算：**

![添加图片注释，不超过 140 字（可选）](/img/9e6e7ed17aad4f2b93c6ef4f91bf6fcd.png)
